    ...
    <el-tabs v-model="activeName"
            ...
            <el-row :gutter="20">
              <el-col :md="24" :lg="24">
                <h2 class="project-online_title">
                  ...
                  <i @click="deleteMock(mockForm.id,mockForm.simulateCode)"
                     class="project-online_del iconfont icon-delete"></i>
                </h2>
              ...
              <el-col :md="8" :lg="8">
                <el-form-item label="模拟效果">
                  <el-select v-model="mockForm.simulateResult"
                             placeholder="请选择"
                             style="width: 100%">
                    <el-option
                      v-for="item in effectSelect"
                      :key="item.dictSort"
                  ...
                  <div v-for="fileInfo in convertToArray(mockForm.filePath)">
                    <div class="problem-item">
                      ...
                      <div class="problem-item_btn">
                        ...
                        <i @click="deleteUploadFile(mockForm.id,fileInfo.id,fileInfo.name)"
                           class="iconfont icon-delete"></i>
                      </div>
                    </div>
                  </div>
                </el-form-item>
              </el-col>
              <el-col :md="1" :lg="1"><i class="iconfont icon-new-add add-problem"
                                         @click="openUploadWindow(mockForm.id,mockForm)"></i></el-col>
            </el-row>
            <el-row>
      ...
      <el-tab-pane label="上线可行性评估" name="second">
        <div class="w-table-btn">
          <span @click="confirmWorkByType('3')" :class="{ active:onlineActive }"><i class="iconfont icon-conf-complete"></i>确认完成</span>
        </div>
        <el-form labelWidth="80px" size="medium">
          ...
          <el-row>
              ...
              <el-form-item label="">
                <div v-for="fileInfo in  onlineFile">
                  <div class="problem-item">
                    ...
                    <div class="problem-item_btn">
                      <i @click="downloadInfo(fileInfo.url)" class="iconfont icon-download"></i>
                      <i @click="deleteOnlineFile(fileInfo.id,fileInfo.name)"
                         class="iconfont icon-delete"></i>
                    </div>
                  </div>
                </div>
            ...
            <el-col :md="1" :lg="1"><i @click="openUploadWindow('3')" class="iconfont icon-new-add add-problem"></i>
            </el-col>
          </el-row>
        </el-form>
      </el-tab-pane>
      <el-tab-pane label="上线切换方案" name="third">
        <div class="w-table-btn">
          <span  @click="confirmWorkByType('4')"  :class="{ active:switchActive }"><i class="iconfont icon-conf-complete"></i>确认完成</span>
        </div>
        <el-form labelWidth="80px" size="medium">
          <el-row>
            <el-col :md="24" :lg="24">
            ...
            <el-col :md="1" :lg="1"><i @click="openUploadWindow('5')" class="iconfont icon-new-add add-problem"></i></el-col>
          </el-row>
          <el-row>
            <el-col :md="24" :lg="24">
            ...
            <el-col :md="24" :lg="24">
              <el-upload
                ...
                :on-remove="deleteSwitchImg"
                :file-list="switchImgFile">
